    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative rounded-3xl border border-border bg-card backdrop-blur-xl p-8 shadow-2xl">
          ...
          {/* Social Login */}
          <div>
            <button className="w-full py-3 px-4 rounded-xl border border-border bg-muted/50 text-foreground font-medium hover:bg-muted transition-all duration-200 flex items-center justify-center gap-2">
